...
<body>
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md bg-white border-bottom shadow-sm mb-3">
    <h5 class="my-0 mr-md-auto font_weight_normal">Laravel App</h5>
    <nav class="my-2 my-md-0 mr-md-3">
        <a href="{{route('home') }} " class="p-2 text-dark">Home</a>
        <a href="{{route('contact') }} " class="p-2 text-dark">Contact</a>
